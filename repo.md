...
GDPR的关于用户数据定义已非常清晰：personal identifier Information——就是说，如果可以通过该数据定位到用户，则该数据被认为是PII（personal identifier Information）其中既包括姓名、身份证号码、定位数据、在线身份识别等自然人的标识信息物理、也包括生理、遗传、心理、经济、文化或社会身份等自然人的要素。
...
###### 一些思考.jpg
所谓“数据分级分类制度”和“重要数据目录”都是数据安全法提出的中国特色的新概念，但是
